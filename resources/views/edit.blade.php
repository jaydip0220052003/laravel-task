                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card card-primary">
                                ...
                                <form action="{{url('updatep',$edit->id)}}" method="post">
                                    @method('PATCH')
                                    @csrf
                                    <div class="card-body">
                                            ...
                                            <input type="email" class="form-control" id="exampleInputEmail1" name="email" value="{{$edit->email}}" placeholder="Enter email">
                                              ...
                                              <div class="form-group">
                                                ...
                                                <select class="form-control" name='dep'>
                                                  <option value='1'>App Devlopment</option>
                                                  <option value='2'>Web Devloper</option>
                                                  <option value='3'>UiUx Desing</option>
                                                  <option value='4'>Softwere</option>
                                                </select>
                                              </div>
                                              <div class="form-group">
